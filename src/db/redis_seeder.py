...
for _uf in [
    ...
    _URL_BASES[f"TJ{_uf}"] = f"https://www.tj{_uf.lower()}.jus.br/jurisprudencia/tema/{{}}"
...
for _uf in [
    ...
    _URL_BASES[f"TRE{_uf}"] = f"https://www.tre-{_uf.lower()}.jus.br/jurisprudencia/tema/{{}}"
...
def get_url(tribunal: str, theme_number: int) -> str:
    template = TRIBUNAL_URLS.get(tribunal, "https://www.jusbrasil.com.br/jurisprudencia/{}")
